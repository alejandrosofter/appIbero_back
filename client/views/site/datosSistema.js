...
Template.tablaSistema.events({
    'click #generarVariables': function(ev) {
       UIBlock.block('aguarde...'); 
     Meteor.call("generarVariables",function(err,res){   
      UIBlock.unblock();
 swal("GENIAL!","Se han actualizado los datos","success");
 });
  },
    'click #importarAnclajes': function(ev) {
       UIBlock.block('aguarde...'); 
     Meteor.call("importarAnclajes",function(err,res){ 
     UIBlock.unblock();  
 swal("GENIAL!","Se han actualizado los datos: "+res,"success");
 });
  },
  'click #eliminaAnclajes': function(ev) {
    UIBlock.block('aguarde...'); 
     Meteor.call("eliminarAnclajes",function(err,res){   
      UIBlock.unblock();
 swal("GENIAL!","Se han actualizado los datos","success");
 });
  },
